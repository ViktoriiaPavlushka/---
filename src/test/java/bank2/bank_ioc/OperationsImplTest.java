...
class OperationsImplTest {
    ...
    void setUp() {
        ...
        operations = new OperationsImpl(exchangeRateRepository, repository);
    }
    ...
    void exchange_exchangesMoneyBetweenCards() {
        ...
        when(repository.Get(anyString())).thenReturn(account);
        when(exchangeRateRepository.GetRate(any(Currency.class), any(Currency.class))).thenReturn(1.0);
